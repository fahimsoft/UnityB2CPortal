        ...
        t.prototype = {
            ...
            applyPlacement: function (e, t) {
                ...
                n.offset(e).addClass(t).addClass("in"),
                    ...
                    t == "bottom" || t == "top"
                        ? ((u = 0), e.left < 0 && ((u = e.left * -2), (e.left = 0), n.offset(e), (s = n[0].offsetWidth), (o = n[0].offsetHeight)), this.replaceArrow(u - r + s, s, "left"))
                ...
                return (
                    ...
                    !this.query || this.query.length < this.options.minLength
                        ? this.shown
                            ? this.hide()
                            : this
                        : ((n = e.isFunction(this.source) ? this.source(this.query, e.proxy(this.process, this)) : this.source), n ? this.process(n) : this)
                );
            },
            process: function (t) {
                var n = this;
