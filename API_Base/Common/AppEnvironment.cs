...
namespace API_Base.Common
{
    public  class AppEnvironment
    {
        ...
        //public  string GetCookie(object commentguid)
        //{
        ...
        public  decimal TotalPrice(decimal total)
        {
            return total += total;
        }

        public  List<T> ToNonNullList<T>(IEnumerable<T> obj)
        {
            return obj == null ? new List<T>() : obj.ToList();
        }
        public  object CopyPropertiesTo(object fromObject, object toObject)
        {
            try
            {
        ...
        public  string GenrateOrderNumber(string num)
        {
            string num2 = num;
        ...
        public  string GetConvertedCurrencyAmount(string from, string to)
        {
            try
            {
                Root root = new Root();
        ...
        public   ResponseViewModel ResponseHandler(dynamic dynamicmodel)
        {
